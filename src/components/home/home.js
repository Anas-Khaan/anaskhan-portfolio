...
export default function home(props) {
    ...
    return (
        <>
            {/* Intro */}
            <div className="main-container pb-5 gx-0">
                <div className="row fluid-container d-flex justify-content-center align-content-center gx-0 me-0 me-lg-5 ">
                    <div className="col-12 col-lg-7 col-xxl-6  intro justify-content-center align-self-center text-center text-lg-start text-xxl-center order-lg-1 order-2" >
                        <div className='justify-content-center align-self-center'>
                            <h1 className="fw-normal">Muhammad Anas</h1>
                    ...
                    <div className="col-12 col-lg-4 order-lg-2 col-xxl-6  order-1 image-div">
                        <img className={`image-${props.theme} m-3`} alt='' src="./anas.svg"></img>
                    </div>
                </div>
                ...
                {/* Technologies */}
                <div className="technologies common-styling p-4 p-md-0" id='about'>
                    <div >
